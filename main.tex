...
\begin{tabular}{m{3cm} l}
    ...
    \begin{tabular}{@{}l}
        \multicolumn{1}{c}{\textbf{\LARGE Nguyễn Hữu Lộc} \quad \textbf{\large Backend Developer Fresher}} \\[10pt]
        \begin{tabular}{@{}ll@{}}
...
Motivated Java Backend Developer experienced in building scalable web apps with Spring Boot. Skilled in RESTful APIs, MySQL, MongoDB, and secure auth using Spring Security \& JWT. Familiar with microservices and WebSocket. Passionate about clean code and continuous learning.
