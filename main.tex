...
\begin{tabular}{m{3cm} l}
    ...
    \begin{tabular}{@{}l}
        \multicolumn{1}{c}{\textbf{\LARGE Nguyễn Hữu Lộc} \quad \textbf{\large Fresher Java Developer}} \\[10pt]
        \begin{tabular}{@{}ll@{}}
...
Backend Developer with hands-on experience in building scalable web applications using Java (Spring Boot). Skilled in designing RESTful APIs, working with MySQL/MongoDB, and implementing secure, maintainable backend logic. Passionate about clean code, problem-solving, and working in collaborative environments.
...
\begin{tabularx}{\linewidth}{X X X} 
    ...
    MySQL, MongoDB, Redis & Java, JavaScript & English: Scored 5.0 on IELTS practice test (DOL English Center) \\
...
\noindent\rule{\linewidth}{0.5pt} % Đường gạch nhẹ
\begin{itemize}
    \item \textbf{Hackathon 2025 (Top 2) - Sai Gon University}: Led backend development in a team of 3. Built AI-powered learning system using OpenAI. Enhanced skills in team collaboration, API integration, and fast delivery. \href{https://github.com/LocNguyenSGU/Hackathon_Luong_Nghin_Do}{\uline{GitHub Repository}}
\end{itemize}
