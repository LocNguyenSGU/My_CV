...
\begin{tabular}{m{3cm} l}
    ...
    \begin{tabular}{@{}l}
        \multicolumn{1}{c}{\textbf{\LARGE Nguyễn Hữu Lộc} \quad \textbf{\large Java Intern Backend}} \\[10pt]
        \begin{tabular}{@{}ll@{}}
...
I am a final-year Information Technology student with a short-term goal of gaining practical experience through my internship and a long-term goal of becoming a professional software developer, contributing to large-scale projects and building a sustainable career in the tech industry.
\section{Education}
\vspace{-10pt}
...
\begin{tabularx}{\linewidth}{l X}
    ...
    & GPA: 3.32/4 (8.1/10) \\ 
    & Scholarship: 4 times \textit{(Encouragement Scholarship)}
\end{tabularx}
...
\begin{tabularx}{\linewidth}{X X X} 
    \textbf{Database} & \textbf{Languages} & \\
    MySQL, Redis, MongoDB & Java, JavaScript, PHP \\

    \textbf{Version Control} & \textbf{Backend} & \textbf{Frontend} \\
    Git/GitHub & Spring Boot, Servlet, REST API, WebSocket, Microservices architecture & ReactJS, JSP \\

    \textbf{Tools} & \textbf{Security \& Integration} \\
    Docker, Swagger, Git, AWS-EC2 & Spring Security, JWT, Paypal API \\
\end{tabularx}
...
\begin{tabularx}{\linewidth}{@{}p{3cm} p{4.5cm} @{ }X}
    \textbf{12/2024 - 06/2025} & \textbf{Calligo} & \\
    & \textbf{Description:} & A real-time messaging platform built using a microservices architecture. It supports instant messaging, and real-time notifications. \\
